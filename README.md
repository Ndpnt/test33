# Declarations of terms tracked in the *test33* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test33-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test33-versions/releases) in the `Ndpnt/test33-versions` repository.
